...
The design can then be machine knitted. The image below, also captured from the paper, shows how the behaviour of the machine knitted design compare to that of the simulation.  
