...
For simplicity and to keep this short, I applied both the distance and angle randomization at the same time. This made the resulting tree, shown below, less symmetrical than the original, but still not realistic enough. The image below shows the tree growth when I draw [initProbTree()]() and hit "n" and "m" multiple times.
...
<img src="https://github.com/RazanAl/CSCI-7000-Computational-Fabrication/blob/main/imgs/lsystem-2024_10_6-21_47_15.png?raw=true" height="100">
